...
The student will validate its functioning in several complex scenarios that include a person accompanying by a social robot and autonomous car track following. We use Casadi as the optimization frontend and CoppeliaSim for simulation.
